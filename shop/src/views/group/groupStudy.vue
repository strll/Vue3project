...
import {
  addgroupStudyGroup,
  addtodayEatGroup, deletegroupStudyGroup,
  deletetodayEatGroup, getgroupStudyGroup,
  gettodayEatGroup
} from "@/utils/request";
...
export default {
  ...
  setup(){
    ...
    const gettodayEatGrouppage=()=>{
      getgroupStudyGroup().then(response=>{
    ...
    const addroot = () => {
      addgroupStudyGroup(data.rootname).then(()=>{
        data.rootname="",
    ...
    const deleteRow = (index) => {
      ...
      ElMessageBox.confirm(
          ...
          .then(() => {
            ...
            deletegroupStudyGroup(index.row.message).then(()=>{
              data.rootname="",
                  dialogFormVisible.value = false
              data.tableData=[]
              getgroupStudyGroup().then(response=>{
