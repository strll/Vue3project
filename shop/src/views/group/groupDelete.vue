...
import {
  addmessagedeleteGroup,
  addtodayEatGroup, deletemessagedeleteGroup,
  deletetodayEatGroup, getmessagedeleteGroup,
  gettodayEatGroup
} from "@/utils/request";
...
export default {
  ...
  setup(){
    ...
    const gettodayEatGrouppage=()=>{
      getmessagedeleteGroup().then(response=>{
    ...
    const addroot = () => {
      addmessagedeleteGroup(data.rootname).then(()=>{
        data.rootname="",
    ...
    const deleteRow = (index) => {
      ...
      ElMessageBox.confirm(
          ...
          .then(() => {
            ...
            deletemessagedeleteGroup(index.row.message).then(()=>{
              data.rootname="",
                  dialogFormVisible.value = false
              data.tableData=[]
              getmessagedeleteGroup().then(response=>{
