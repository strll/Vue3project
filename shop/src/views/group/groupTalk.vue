...
import {
  addgroupReplyGroup,
  addtodayEatGroup, deletegroupReplyGroup,
  deletetodayEatGroup, getgroupReplyGroup,
  gettodayEatGroup
} from "@/utils/request";
...
export default {
  ...
  setup(){
    ...
    const gettodayEatGrouppage=()=>{
      getgroupReplyGroup().then(response=>{
    ...
    const addroot = () => {
      addgroupReplyGroup(data.rootname).then(()=>{
        data.rootname="",
    ...
    const deleteRow = (index) => {
      ...
      ElMessageBox.confirm(
          ...
          .then(() => {
            ...
            deletegroupReplyGroup(index.row.message).then(()=>{
              data.rootname="",
                  dialogFormVisible.value = false
              data.tableData=[]
              getgroupReplyGroup().then(response=>{
